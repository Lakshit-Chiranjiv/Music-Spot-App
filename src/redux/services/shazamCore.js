...
export const { useGetTopChartsQuery, useGetSongDetailsQuery, useGetSongRelatedDetailsQuery, useGetArtistDetailsQuery, useGetSongsByCountryQuery } = shazamCoreApi